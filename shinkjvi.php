  ...
  <div class="content" style="margin-left: 100px; margin-right:100px;">
      <div class="page">
          <div class="content-main">
            <h1 style="margin-bottom: 20px; font-style: italic; font-weight: bold;"> Shiknjvi </h1>
            <div style="width: 40%; float: right; margin:0 0 20px 20px;">
            <img class="recipe-img" src="images\shinkjvi.jpg" alt="Shinkjvi" style="width: 100%; box-shadow: 0 0 1px 0 #000;">
            ...
            <td style="width: 40%; text-align: right;"> 15 </td>
            </tr>
            <tr style="border-bottom: 1px dotted #ccc;">
          ...
          <p style="margin-bottom: 20px;">
            ...
            <ul>
            <li>Squeeze the lemons equally into 2 glasses.</li>
            <br>
            <li>Add sugar, salt, black salt, coriander powder, pepper powder, cumin powder and ice cubes.</li>
            <br>
            <li>Stir till sugar dissolves. In a mortar pestle lightly crush the mint leaves and then add them to the 2 glasses.</li>
            <br>
            <li>In one glass top it with water and the other with soda. Serve Chilled.</li>
            <br>
            </ul>
          </p>
          </div>
